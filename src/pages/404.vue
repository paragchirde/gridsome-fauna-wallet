<template>
    <div>
        <div class="flex flex-col text-center mx-auto">
            <div class="mx-auto">
            <g-image src="../assets/images/error.svg" id="errorImg"></g-image>
            </div>
            <div class="mx-auto">
            ...
            <p class="text-4xl font-mono">Psst, You're lost. This page doesn't exists</p>
            <button class="bg-blue mx-auto rounded-lg inline-block px-4 py-2 font-mono text-white" @click="checkout()">Go to Dashboard</button>
        </div>
    </div>
</template>
<script>
